...
export const RenderCellColor = ({ params }) => {
  const colors = params?.row?.colors || [];

  return (
   <Select size="small" defaultValue={colors[0]} sx={{ width: 120 }}>
...
export const RenderCellSize = ({ params }) => {
  const sizes = params?.row?.sizes || [];

  return (
    <Select size="small" defaultValue={sizes[0]} sx={{ width: 80 }}>
