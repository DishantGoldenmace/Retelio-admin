...
const Jwt = {
  ...
  ForgotVerifyPage: lazy(() => import('src/pages/auth/jwt/forgot-verify')),
...
export const authRoutes = [
  {
    ...
    children: [
      // ✅ Add this redirect route at the top
      {
        index: true, // this means path "/"
        element: <Navigate to="/jwt/sign-in" replace />,
      },
      authJwt,
      authAmplify,
      authFirebase,
